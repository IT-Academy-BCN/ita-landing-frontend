...
export const {sendEmailSuccess, sendEmailFailure} = apiSendCodeByEmail.actions


export const handleSubmit = async (dispatch: Dispatch , email: string, acces_token:string) => {
    try{
        const config = {
            headers: {
        ...
        await axios.post('http://87.106.229.119/api/send-code-by-email', { email }, config);
