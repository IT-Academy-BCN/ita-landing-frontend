...
function Collaborators() {
    ...
    const VT = "Ver Todos >";
    const btnActive = " px-6 mb-5 ml-2 btn btn-ghost text-sm normal-case rounded-3xl bg-[#025E7E] text-white  ";
    const btnInactive = "px-6 mb-5 ml-2 btn btn-ghost text-sm normal-case rounded-3xl active:bg-[#025E7E] active:text-white border-solid lg:border-transparent   border-2 border-indigo-900 min-w-10  ";
