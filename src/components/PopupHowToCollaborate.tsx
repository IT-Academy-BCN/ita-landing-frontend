...
const PopupHowToCollaborate: React.FC<{ onClose: () => void }> = ({
  onClose,
}) => {
      ...
      <div className="bg-white flex-col border-2 rounded-xl top-40 font-black bg-opacity-80 fixed z-50 container mx-auto">
        ...
        <div className="flex z-50 rounded-xl bg-white flex-wrap items-center justify-center bg-opacity-80 mb-24">
          <CardComponentPopupCollaborate
            ...
            description={t(
              "landingPage.buttonCollaborate.firstCard.description"
            )}
          />
          ...
          <CardComponentPopupCollaborate
            ...
            description={t(
              "landingPage.buttonCollaborate.secondCard.description"
            )}
          />
          ...
          <CardComponentPopupCollaborate
            ...
            description={t(
              "landingPage.buttonCollaborate.thirdCard.description"
            )}
          />
        </div>
      </div>
