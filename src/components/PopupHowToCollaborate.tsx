    ...
    <div className="font-black">
      <p className="flex items-center justify-start">
        <span
          ...
          onClick={() => setisPopupOpenLocal(true)}
        >
          <img
            src={selector}
            className="h-6 w-6 mr-2"
            alt="Icono de selector"
          />
        </span>
        ¿Cómo colaborar?
      </p>
        ...
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-80">
          <div className="bg-white p-6 rounded-lg max-w-md">
            ...
            <div className="flex flex-wrap items-center justify-center container mx-auto">
                ...
                description={
                "Resolvera todas tus dudas y te ayudara con setup del proyecto"
                }
                />
                ...
                description={
                "Tu mentor de proyecto te ayudará"
                }
                />
