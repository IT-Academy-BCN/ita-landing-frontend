...
const PasswordReminderComponent = ({
  ...
  const requestStatus = useSelector(
    (state: RootState) => state.apiSliceResetPassword.requestStatus
  );
        ...
        <div>
          ...
          >
            ...
            <div className="flex flex-col  justify-evenly h-60 px-5 py-0">
              ...
              <p className="text-sm">
                Esta dirección de correo no está vinculada a ninguna cuenta
              </p>
              <button className="btn btn-error" onClick={handleReopenModal}>
                Volver a intentar
              </button>
            </div>
          </div>
        ...
        <div>
          ...
          >
            ...
            <div className="flex flex-col  justify-evenly h-60 px-5 py-0">
              ...
              <p className="text-sm">
                Un link ha sido enviado a tu correo para crear una nueva
                contraseña
              </p>
              <button
