        ...
        <div className={`absolute z-50 right-0 top-full mt-6 w-80 rounded-xl bg-white border-2 `}>
          ...
          <div className="flex flex-col justify-evenly h-[500px] px-5 py-0 ">
            ...
            <form onSubmit={submitInformation}>
              ...
              <input  name="name" type="text" className="mt-2 input input-bordered w-full max-w-xs" placeholder="Nombre" />
              <input  name="Code" type="text" className="mt-2 input input-bordered w-full max-w-xs" placeholder="Codigo de confirmación" />
              <button type='submit' className='mt-5 btn btn-wide bg-pink-it text-white'>Registro</button>
            </form> 

            {/* Icono de carga */}
            {
              !isLoadingMessageError ?  <p>{messageError}</p> : <div className='flex justify-center'><span className=" loading loading-spinner loading-lg "></span></div> 
            }
