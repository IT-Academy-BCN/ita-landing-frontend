          ...
          >
            {window.location.pathname === "/backoffice" && (
              <div className="flex place-content-end gap-2">
                <button
                  className="bg-white px-4 py-1 mt-4"
                  onClick={() => {
            ...
            {window.location.pathname === "/" && (
              <a
                href={app.github}
                className="flex place-content-end px-4 py-1 mt-4"
                target="_blank"
              >
            ...
            <p className="flex-grow text-left ml-4 mr-8 my-4 line-clamp-4 leading-7 text-[#7e7e7e]">
              {app.description}
            </p>
            <a
              href={app.url}
              className="flex mb-4 mx-4 btn btn-outline bg-base-100 border-none normal-case"
              target="_blank"
            >
