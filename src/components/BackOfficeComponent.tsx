      ...
      <main className="grid grid-cols-6  w-screen min-h-screen  bg-backOffice-main">
        <nav>
          ...
          <div className="grid grid-rows-3 my-10">
            <button
              className={`flex justify-center items-center py-2 my-4 ml-2 ${
                boldFont.boldFaqs ? "font-bold" : "font-normal"
              }`}
              onClick={() => {
            ...
            >
              <div
                className={`w-2 h-2 rounded-full mr-2 bg-[#BA007C] ${
                  boldFont.boldFaqs ? "" : "hidden"
                }`}
              ></div>
              FAQs
            </button>
            ...
            <button
              className={`flex justify-center items-center py-2 my-4 ml-2 ${
                boldFont.boldProjectsComponent ? "font-bold" : "font-normal"
              }`}
              onClick={() => {
          ...
          <button
            onClick={() => dispatch(setIsLogged(false))}
            className="flex py-2 px-3 my-4 ml-2"
          >
            {" "}
            <img src={LogoOut} alt="" />
            Logout
        ...
        <div className=" col-span-5 m-5 bg-white rounded-md">
          <div
            className={`mt-20 ${state.faqs ? "component hidden" : "component"}`}
          >
            <FAQs />
          </div>
          ...
          <div
            className={
              state.projectsComponent ? "component hidden" : "component"
            }
          >
            <ProjectsComponent />
          </div>
